 ...
 */
public class AddNewTreeTypeView extends View {
    ...
    public AddNewTreeTypeView(IModel model) {
        super(model, "AddNewTreeTypeView");
    ...
    public void processAction(Event evt)
    {
        ...
        if (clickedBtn.getId().equals("1") == true)
        {
            ...
            else
            {
                ...
                {
                    System.out.print("Error New Tree Type Add");
                }
            }
        }
    ...
    private void refreshFormContents()
    {
        ...
        alertBodySucceeded = alerts.getString("AddTreeTypeBodySucceeded");
    }
